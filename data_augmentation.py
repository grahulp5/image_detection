...
imagespath = '/Users/rahulgupta/Desktop/DANA/Assignment_3_2/Data_Aug/Example/'
...
def getTransform(loop):
    ...
    if loop == 0:
        ...
        transform = A.Compose([
            A.ImageCompression(quality_lower=0, quality_upper=1, p=1)
        ], bbox_params=A.BboxParams(format='yolo'))
        ...
        transform = A.Compose([
            A.RandomResizedCrop(512, 512, scale=(0.08, 1.0), ratio=(0.75, 1.333), p=1),
        ], bbox_params=A.BboxParams(format='yolo'))
